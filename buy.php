...
?>
        ...
        <div class="container" style="margin-top: 20px; margin-bottom: 20px; color:black;">
            ...
            <div class="row">
                <div class="container">
                    <div class="row text-center pb-4 float-end">
                        ...
                        <div class="col-md-auto">
                        <form action="buy.php" method="POST">
                            <input class="btn btn-primary" type='hidden' name="data-id" value="Normal">
                            <input class="btn btn-primary" type="submit" name="rare" value="Normal">
                        </form>
                        </div>
                        <div class="col-md-auto">
                        <form action="buy.php" method="POST">
                            <input class="btn btn-primary" type='hidden' name="data-id" value="Genuine">
                            <input class="btn btn-primary" type="submit" name="rare" value="Genuine">
                        </form>
                        </div>
                        <div class="col-md-auto">
                        <form action="buy.php" method="POST">
                            <input class="btn btn-primary" type='hidden' name="data-id" value="Unique">
                            <input class="btn btn-primary" type="submit" name="rare" value="Unique">
                        </form>
                        </div>
                        <div class="col-md-auto">
                        <form action="buy.php" method="POST">
                            <input class="btn btn-primary" type='hidden' name="data-id" value="Unusual">
                            <input class="btn btn-primary" type="submit" name="rare" value="Unusual">
                        </form>
                        </div>
                    </form>
                    </div>
