 		...
 		<div class="loginFormContainer">
 			...
 			<form class="loginForm" action="" method="POST">
 				<input class="loginInput" type="text" id="username" name="username" placeholder="Username" value="<?php
					if (!empty($errors) && !isset($_errors['username'][0])) { #this is done to keep the value inputted by the user if this field is valid but others are not
							echo $_POST['username'];
						}
						?>"><br>
 				<?php
				...
				if (!empty($errors) && !isset($_errors['email'][0])) {
						echo $_POST['email'];
					}
					?>"><br>
 				<?php
